...
#define rotate_cw 6//Esteban          // goes high to activate rotator R (CW) rotation - pin 1 on Yaesu connector
#define rotate_ccw 7//Esteban     // goes high to activate rotator L (CCW) rotation - pin 2 on Yaesu connector
//#define rotator_cw A0//Esteban    // reads analog azimuth voltage from rotator - pin 4 on Yaesu connector
#define rotator_analog_az A0
#define button_cw A2//Esteban             // normally open button to ground for manual CW rotation (schematic pin: A1)
#define button_ccw A3//Esteban             // normally open button to ground for manual CCW rotation (schematic pin: A2)

/*Not Used on Schematic*/
...
#define azimuth_speed_voltage 10//Esteban   // optional - PWM output for speed control voltage feed into rotator (on continually unlike rotate_cw_pwm and rotate_ccw_pwm)
...
#define preset_start_button 0//Esteban**    // connect to momentary switch (ground on button press) for preset start (set to 0 to disable or for preset automatic start)
...
#define rotator_analog_el A1//Esteban      // reads analog elevation voltage from rotator
#define button_up A4//Esteban               // normally open button to ground for manual up elevation
#define button_down A5//Esteban             // normally open button to ground for manual down rotation
#define rotate_up 8	//Esteban               // goes high to activate rotator elevation up
#define rotate_down 9 //Esteban     // goes high to activate rotator elevation down
